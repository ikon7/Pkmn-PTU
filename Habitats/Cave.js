...
var pokemonInRoute = [
    ...
    'Zweilous', 'Hydreigon', 'Tyrunt', 'Tyrantrum', 'Amaura', 'Aurorus', 'Carbink', 'Noibat', 'Noivern', 'YUNGOOS', 'GUMSHOOS', 'DEWPIDER', 'ARAQUANID', 'SALANDIT', 'SALAZZLE', 
    'WIMPOD', 'GOLISOPOD', 'TYPE:NULL', 'SILVALLY', 'MINIOR(meteor)', 'MINIOR(core)', 'JANGMOO', 'HAKAMOO', 'KOMMOO', 'RATTATA(alola)', 'RATICATE(alola)', 'DIGLETT(alola)', 
    'DUGTRIO(alola)', 'GEODUDE(alola)', 'GRAVELER(alola)', 'GOLEM(alola)', 'MAROWAK(alola)', 'ROLYCOLY', 'CARKOL', 'COALOSSAL', 'STUNFISK(galar)', 'CHARCADET', 'ARMOROUGE', 
    'CERULEDGE', 'ORTHWORM', 'GLIMMET', 'GLIMMORA', 'HOUNDSTONE', 'DUDUNSPARCE', 'KINGAMBIT', 'FRIGIBAX', 'ARCTIBAX'
];
